...
C {devices/capa.sym} 550 180 0 0 {name=C1
m=1
value=CACE\{cl\}
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 550 230 0 0 {name=l2 lab=GND}
C {devices/lab_wire.sym} 390 100 0 0 {name=p3 sig_type=std_logic lab=Vp}
C {devices/lab_wire.sym} 390 160 0 0 {name=p4 sig_type=std_logic lab=Vn}
...
.option warn=1
"}
C {devices/lab_wire.sym} 550 130 0 1 {name=p11 sig_type=std_logic lab=Vout}
