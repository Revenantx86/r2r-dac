...
C {devices/lab_wire.sym} 620 60 0 0 {name=p4 sig_type=std_logic lab=VDD}
...
C {devices/lab_wire.sym} 540 90 0 0 {name=p5 sig_type=std_logic lab=Vp}
C {devices/lab_wire.sym} 540 150 0 0 {name=p6 sig_type=std_logic lab=Vn}
...
C {devices/lab_wire.sym} 620 180 2 1 {name=p14 sig_type=std_logic lab=VSS}
